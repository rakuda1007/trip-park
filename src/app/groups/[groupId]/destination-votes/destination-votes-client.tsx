...
const ANSWER_COLORS: Record<DestinationAnswer, string> = {
  first: "bg-emerald-100 text-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-200",
  want: "bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-200",
