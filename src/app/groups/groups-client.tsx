...
export function GroupsClient() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl flex-1 px-4 pb-10 pt-4 sm:pb-14 sm:pt-5">
          ...
          {highlight ? (
            <div>
              ...
              <GroupCard
                ...
                highlight
                showThumbnail={Boolean(
                  highlight.data.memoryPhotoUrl &&
                    highlight.data.memoryPhotoVisible,
                )}
                onDelete={
                ...
                {active.slice(1).map(({ groupId, data }) => (
                  <li key={groupId}>
                    <GroupCard
                      ...
                      today={today}
                      showThumbnail={Boolean(
                        data.memoryPhotoUrl && data.memoryPhotoVisible,
                      )}
                      onDelete={
                        data.role === "owner"
